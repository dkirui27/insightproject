...
X_train = st.cache_data(pd.read_csv)(os.path.join(DATA_DIR, "train_features.csv"))
Y_train = st.cache_data(pd.read_csv)(os.path.join(DATA_DIR, "train_labels.csv"))
X_test = st.cache_data(pd.read_csv)(os.path.join(DATA_DIR, "test_features.csv"))
Y_test = st.cache_data(pd.read_csv)(os.path.join(DATA_DIR, "test_labels.csv"))
